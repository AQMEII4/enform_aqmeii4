...
C --- Read and store values
      ...
      DO IT = 1, NT
	   ...
	   DO I = 1, NX
	    IF (VALUES_GR(I,J,IT) .GT. MIN_POS) THEN
	     VALUES_GR(I,J,IT) = 1. / VALUES_GR(I,J,IT)
	    ELSE
	     IF (ABS(VALUES_GR(I,J,IT) - VAL_MISSING).GT.EPS) THEN
	      VALUES_GR(I,J,IT) = 1. / MIN_POS
	     ENDIF
	    ENDIF
	   ENDDO !I
	  ENDIF 
